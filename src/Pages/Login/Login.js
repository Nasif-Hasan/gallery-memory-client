...
const Login = () => {
    ...
    return (
        <div>
            <div className="w-full max-w-md my-10 p-4 rounded-md mx-auto shadow sm:p-8 dark:bg-gray-900 dark:text-gray-100">
                <h2 className="mb-3 text-3xl font-semibold text-center">Login to your account</h2>
                <p className="text-sm text-center dark:text-gray-400">Don't have an account?
                    <Link to='/register' rel="noopener noreferrer" className="focus:underline hover:underline  text-orange-400">Register here</Link>
                </p>
                <div className="my-6 space-y-4">
                    <button aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-400 focus:ring-violet-400">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current text-orange-400">
                ...
                <form  onSubmit={handleLogin} novalidate="" action="" className="space-y-8 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <input type="password" name="password" id="password" placeholder="*****" className="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-orange-400" />
                        </div>
                    </div>
                    <button type="submit" className="w-full px-8 py-3 font-semibold rounded-md dark:bg-orange-400 dark:text-gray-900">Login</button>
                </form>
            </div>
        </div>
        ...
        //     </div>
        //     <form onSubmit={handleLogin} novalidate="" action="" className="space-y-12 ng-untouched ng-pristine ng-valid">
        //         <div className="space-y-4">
        //             <div>
        ...
        //         <div className="space-y-2">
        //             <div>
        //                 <button type="button" className="w-full px-8 py-3 font-semibold rounded-md dark:bg-orange-400 dark:text-gray-900">Sign in</button>
        //             </div>
        //             <p className="px-6 text-sm text-center dark:text-gray-400">Don't have an account yet?
        //                 <Link rel="noopener noreferrer" to='/register' className="hover:underline dark:text-orange-400">Register</Link>.
        //             </p>
        //         </div>
        //     </form>
        // </div>
